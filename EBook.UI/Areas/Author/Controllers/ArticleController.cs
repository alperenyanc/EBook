...
using EBook.UI.Areas.Author.Models.DTO;
using EBook.UI.Areas.Author.Models.VM;
using EBook.Utility;
using System;
...
namespace EBook.UI.Areas.Author.Controllers
{
    public class ArticleController : Controller
    {
        //atticcle kontroller category subcategory article appuser
